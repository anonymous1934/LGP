...
default_kwargs = {
    ...
    "aug_grayscale": True,
    "num_workers": 44,
    "experiment_name": "EfficientCVBench",
    "aug_solarize": True,
    "aug_gauss_blur": True,
    ...
    "use_wavelet_embedding": False,
    "wavelet_name": "haar",
    "wavelet_levels": 4,
    "wavelet_fusion": False,
    "channel_dropout": 0.0,
    "token_dropout": 0.0,
    "fusion_drop_path": 0.0,
    "use_position_embedding": False,  # 🚨 LGP 模型不使用位置编码
}
# , 'model_ema': True, 'model_ema_decay': 0.99996}

slurm_defaults = {
    "partition": "A100-SDS,A100-80GB",
    "container-image": "custom_ViT_v09.2.sqsh",
